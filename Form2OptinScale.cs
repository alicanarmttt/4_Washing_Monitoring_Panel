    ...
    public partial class Form2OptinScale : Form
    {
        ...
        public void UpdateForm2PanelVisibility()
        {
            try
            {
                ...
                if (frm.WindowState == FormWindowState.Maximized && frm.PanelMenu.Width < 300)
                {
                    // Form1 tam ekran durumundayken ve yan menü genişken Form2'deki paneli görünür yapın
