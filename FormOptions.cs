...
namespace SmartEye2
{
    public partial class FormOptions : Form
    {
        ...
        {
            Color backColor = Color.FromArgb(213, 236, 252);
            //int thickness = 5;//it's up to you
            //int halfThickness = thickness / 2;
            //using (Pen p = new Pen(Color.FromArgb(135, 208, 240), thickness))
            //{
            //    e.Graphics.DrawRectangle(p, new Rectangle(halfThickness,
            //    halfThickness,
            //                                              tableLayoutPanel1.ClientSize.Width - thickness,
            //                                              tableLayoutPanel1.ClientSize.Height - thickness));
            //}
        }

        private void button1_Click(object sender, EventArgs e)
        {
            seDropDownMenu1.Show(BtnAlanDuz, BtnAlanDuz.Width, 0);
        }
